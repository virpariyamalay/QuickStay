...
const Testimonial = () => {
  return (
    <div className='flex flex-col items-center px-6 md:px-16 lg:px-24 bg-slate-50 py-20 gap-10 pb-30  '>
        <Title title='What Our Guests Says' subtitle='discover why discerning tarvelers  consistently choose QuickStay for their exclusive and luxuries accommodations around the world. '/>
